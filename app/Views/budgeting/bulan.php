        ...
        <section id="modal" class="fixed inset-0 bg-gray-900 bg-opacity-50 items-center justify-center hidden">
            <section class="bg-white rounded-lg shadow-lg w-96">
                <section class="px-6 py-4 border-b">
                    <h2 class="text-lg font-bold text-gray-700">Budgeting</h2>
                </section>
                <form class="px-6 py-4" action="/budgeting/bulan/tambah" method="POST">
                    <?= csrf_field() ?>
                    <!-- Deskripsi -->
                    <section class="mb-4">
                        <label for="nama" class="block text-sm font-medium text-gray-700">Nama</label>
                        <textarea id="nama" name="nama" rows="3" class="w-full px-3 py-2 border rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500"></textarea>
                    </section>
                    <!-- Jumlah -->
                    <section class="mb-4">
