    ...
    <main class=" min-h-svh">
        ...
        <section class="lg:ml-72 transition-all p-5">
            ...
            <section class="flex flex-col lg:flex-row justify-between gap-4">
                <section class="flex justify-center flex-col border bg-gray-50 p-2 rounded-lg w-full lg:w-1/3 h-32 px-5">
                    <h3 class="font-semibold text-gray-900">Saldo tersisa</h3>
                    <h4><?= number_format(user()->saldo) ?></h4>
                </section>
                <section class="flex justify-center flex-col border bg-gray-50 p-2 rounded-lg w-full lg:w-1/3 h-32 px-5">
        ...
        <script>
            ...
            dataPemasukan.push(<?= $pemasukan ?>);
            dataPengeluaran.push(<?= $pengeluaran ?>);
            const data = {
                labels: [
                    'Pemasukan',
                    'Pengeluaran'
                ...
                datasets: [{
                    label: ['Total'],
                    data: [dataPemasukan, dataPengeluaran],
                    backgroundColor: [
                        'rgb(54, 162, 235)',
                        'rgb(255, 99, 132)',
                    ],
