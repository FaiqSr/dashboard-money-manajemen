    ...
    <main class=" min-h-svh">
        ...
        <section class="lg:ml-72 transition-all p-5">
            ...
            <section class="min-h-svh pt-5 flex flex-col lg:flex-row">
                ...
                <section class="ml-0 sm:ml-5 lg:w-full ">
        ...
        <section id="modal" class="fixed inset-0 bg-gray-900 bg-opacity-50 items-center justify-center hidden">
            <section class="bg-white rounded-lg shadow-lg w-96">
                <section class="px-6 py-4 border-b">
                    <h2 class="text-lg font-bold text-gray-700">Tambah Pemasukan</h2>
                </section>
                <form class="px-6 py-4" action="/transaksi/pemasukan" method="POST">
                    <?= csrf_field() ?>
                    <!-- Deskripsi -->
                    <section class="mb-4">
